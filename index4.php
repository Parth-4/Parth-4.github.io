...
<body>
  <nav style="position:fixed !important; z-index: 1.5;">
    <ul>
      ...
      <li class='text'> <a href="./index4.php">Home</a> </li>
      <li class='text'><a href="./about.html"> About us</a></li>
      <li class='text'><a href="./contact.php">Contact</a></li>
      <li class='text'><a href="./log.php">Login|Sign Up</a></li>
      <li class='text'><a href="./admin.php"></a>/</li>
  ...
  <div class='container' id="product-display" style='margin-top: 13.2rem;
   border: 2px solid black
    ...
    ?>
          <div class="col-md-2 especial">
            <?php $i = $row['image'];
            $image = "./upload/$i";
            echo "<a href='simpleDetail.php?product_id=$row[0]'><img src='$image' class='p-image' class='img-responsive dynamic-image' style='position:relative ; z-index:-1'></a>  ";
